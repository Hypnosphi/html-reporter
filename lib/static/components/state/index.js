...
class State extends Component {
    ...
    _drawControlButtons() {
        ...
        const {state, state: {stateName}, acceptHandler, findSameDiffsHandler, serverStopped} = this.props;
        const isAcceptDisabled = !isAcceptable(state) || serverStopped;
        const isFindSameDiffDisabled = !isFailStatus(state.status) || serverStopped;
...
export default connect(
    ({gui, view: {expand, scaleImages}, closeIds, serverStopped}) => ({gui, expand, scaleImages, closeIds, serverStopped})
)(State);
